...
public class MainActivity extends Activity implements ConnectionCallbacks,
    ...
    private void setButtonsEnabledState() {
        if (mRequestingLocationUpdates) {
            ...
            StartPauseResumeButton.setEnabled(true);
    ...
    private void updateUI() {
        if (mCurrentLocation != null) {
            mDistanceTextView.setText(String.valueOf(mCurrentLocation.getLatitude()));
            mAvgSpeedTextView.setText(String.valueOf(mCurrentLocation.getLongitude()));
            mDurationTextView.setText(mLastUpdateTime);
        }
    }
    ...
    public void onLocationChanged(Location location) {
        ...
        mLastUpdateTime = DateFormat.getTimeInstance().format(new Date());
        updateUI();
        Toast.makeText(this, getString(R.string.location_updated),
